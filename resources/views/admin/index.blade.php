...
@section('content')
    <style>
        ...
        .admin-users-page .nav-tabs {
            border-bottom-color: #dfe7f3;
        }

        .admin-users-page .nav-tabs .nav-link {
            padding: 12px 18px;
            color: #526580;
            font-family: "Nunito", sans-serif;
            font-weight: 800;
        ...
        .admin-users-page .nav-tabs .nav-link.active {
            color: var(--user-primary);
            border-color: #dfe7f3 #dfe7f3 #fff;
        }

        .admin-users-page form .form-label {
            margin-bottom: 8px;
            color: var(--user-ink);
            font-family: "Nunito", sans-serif;
        ...
        .admin-users-page form .form-control,
        .admin-users-page form .form-select {
            min-height: 52px;
            padding: 11px 14px;
            color: #334155;
            font-family: "Nunito", sans-serif;
        ...
        .admin-users-page form .form-control:focus,
        .admin-users-page form .form-select:focus {
            border-color: #60a5fa !important;
            box-shadow: 0 0 0 .22rem rgba(59, 130, 246, .13) !important;
        }

        .admin-users-page .select2-container--bootstrap-5 .select2-selection {
            min-height: 52px;
        ...
        .admin-users-page .select2-container--bootstrap-5 .select2-selection--single .select2-selection__rendered {
            display: flex;
            align-items: center;
            height: 50px;
            padding: 0;
        ...
        .admin-users-page .select2-container--bootstrap-5 .select2-selection--single .select2-selection__arrow {
            top: 14px;
            right: 13px;
        }

        .admin-users-page .select2-container--bootstrap-5.select2-container--focus .select2-selection {
            border-color: #60a5fa !important;
            box-shadow: 0 0 0 .22rem rgba(59, 130, 246, .13) !important;
        }

        .admin-users-page .user-register-card {
            border: 0;
            border-radius: 18px;
            box-shadow: 0 14px 32px rgba(15, 23, 42, .08);
        }

        .admin-users-page .user-register-card .card-body {
            padding: 28px;
        }

        .admin-users-page .profile-upload {
            display: flex;
            align-items: center;
            gap: 16px;
            padding: 14px;
        ...
        .admin-users-page .profile-preview {
            width: 72px;
            height: 72px;
            overflow: hidden;
        ...
        .admin-users-page .profile-preview img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        }
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                    ...
                                    <font class="card-title" style="font-size: 15px;">User Accounts</font>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                    type="button" role="tab" aria-controls="profile" aria-selected="false">
                                    <font class="card-title" style="font-size: 15px;"><i class="bi bi-plus-square-fill"
                                            style="font-size: 20px;"></i>&nbsp; Register</font>
                                </button>
                            </li>
                        ...
                        <div class="tab-content pt-2" id="myTabContent">
                                    ...
                                    <div class="card-body"><br>
                                        ...
                                        <form method="POST" action="{{ route('all_user.search') }}"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-2 col-lg-2">
                                                    <label for="validationCustom01" class="form-label card-title"
                                                        style="font-size: 12px;padding:0px;">Branch</label>
                                                    <select class="form-select column_filter" id="branc_id"
                                                        name="branch">
                                        ...
                                        <div class="table-responsive" style="margin: 10px;">
                                            <table class="table table-sm card-title table-hover table-bordered table-fix"
                                                style="font-size: 15px;" id="myTable">
                                                <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($users as $data)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('all_user.show', $data->id) }}"
                                                                    style="text-decoration:none;color:#000">{{ $data->emp_code }}</a>
                                                            </td>
                                                            <td><a href="{{ route('all_user.show', $data->id) }}"
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form action="{{ route('all_user.store') }}" class="needs-validation user-register-form"
                                            ...
                                            <div class="card user-register-card">
                                                ...
                                                <div class="card-body"><br>
                                                                        ...
                                                                        <div>
                                                                            <label for="validationCustom01"
                                                                                ...
                                                                                style="font-size: 15px;"><i
                                                                                    ...
                                                                                    title="We can accept file types as jpg, png, gif,webp or jpeg."></i>
                                                                                User Profile</label>
                                                                            <label for="my_file">
                                                                                <span
                                                                                    ...
                                                                                    data-bs-toggle="tooltip"
                                                                                    data-bs-placement="top"
                                                                                    title="Upload a user profile image."><i
                                                                            ...
                                                                            <div class="small text-muted">Optional — a
                                                                                default profile image will be used when
                                                                                empty.</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            <label for="validationCustom01" class="form-label card-title"
                                                                style="font-size: 15px;">User name</label>
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            <label for="validationCustom01" class="form-label card-title"
                                                                style="font-size: 15px;">Employee ID</label>
                                                            <input type="text"
                                                                class="form-control @error('emp_code') is-invalid @enderror"
                                                                id="validationCustom01" name="emp_code"
                                                                value="{{ old('emp_code') }}"
                                                                style="box-shadow:1px 1px 1px #333;" required>
                                ...
                                Please enter your employee ID.
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            ...
                                                            <select class="form-select mb-3"
                                                                aria-label=".form-select-lg example" name="branch_id"
                                                                style="box-shadow:1px 1px 1px #333;" required>
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            ...
                                                            <input type="password"
                                                                ...
                                                                id="validationCustom01" name="password"
                                                                style="box-shadow:1px 1px 1px #333;"
                             ...
                             Please enter your password.
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            ...
                                                            <input type="password" class="form-control"
                                                                id="validationCustom01" name="password_confirmation"
                                                                style="box-shadow:1px 1px 1px #333;" required>
                                                            @error('password')
                                                                <div class="invalid-feedback card-title"
                                                                    style="color:red;font-size:12px;">
