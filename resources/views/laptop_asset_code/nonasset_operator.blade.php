...
@section('content')
    <style>
        .nonasset-operator-page #clear {
            font-family: "Nunito", sans-serif;
        }

        .nonasset-operator-page #clear .form-label {
            margin-bottom: 9px;
            color: #0f2b78;
            font-family: "Nunito", sans-serif;
        ...
        .nonasset-operator-page #clear .form-control,
        .nonasset-operator-page #clear .form-select {
            min-height: 48px;
            padding: 10px 14px;
            color: #243b64;
            font-family: "Nunito", sans-serif;
        ...
        .nonasset-operator-page #clear .form-control::placeholder {
            color: #94a3b8;
            font-style: italic;
            font-weight: 600;
        }

        .nonasset-operator-page #clear .form-control:focus,
        .nonasset-operator-page #clear .form-select:focus {
            border-color: #3b82f6 !important;
            box-shadow: 0 0 0 .22rem rgba(59, 130, 246, .13) !important;
        }

        .nonasset-operator-page #clear .btn {
            min-height: 48px;
            padding: 10px 19px;
            font-family: "Nunito", sans-serif;
            font-size: 15px;
    ...
    @endif
    <section class="section nonasset-operator-page">
        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-md-10 col-lg-10">
                                                <h4 class="card-title" style="padding-top: 20px;">Non Asset Code Operator
                                                </h4>
                                            </div>
                                                    ...
                                                    <button class="btn">
                                                        <a href="{{ route('laptop_asset_code.create_non_op') }}">
                                                            <i class="bi bi-plus-square-fill"
                                                                style="color:##1c88fc;font-size:33px;"></i></a></button>

                                                    <button class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#import_non" type="button">
                                                        <font class="card-title" style="color:#fff;font-size: 13px;">
                                                            <i class="ri-file-excel-2-line" style="font-size: 12px;"></i>
                                                            Excel Import
                                                        </font>
                                                    </button>
                                                    <!--------------------------------excel import-------------------------------------------------------------->
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        style="font-weight: 500;color: #012970;font-family: Poppins, sans-serif;">
                                                                        <i class="ri-file-excel-2-line"
                                                                            style="font-size: 20px;"></i> Excel Import</h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <h5
                                                                        style="font-size:15px;;font-weight: 500;color: #012970;font-family: Poppins, sans-serif;">
                                                                        <a href="{{ asset('assets/img/nonassetoperatorimport.xlsx') }}"
                                                                            download><u>Download Sample Excel File</u></a>
                                                                    </h5>
                                                                    <form action="{{ route('nonassetoperator.import') }}"
                                                                        ...
                                                                        <label for="my_import">
                                                                            ...
                                                                            <i class="bi bi-upload btn btn-primary btn-sm"
                                                                                data-bs-toggle="tooltip"
                                                                                data-bs-placement="top"
                                                                                title="Employee asset code import excel click the button."></i>

                                                                        </label>
                                                                        <input type="file" id="my_import"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h5
                                                            style="font-size:15px;;font-weight: 500;color: #012970;font-family: Poppins, sans-serif;">
                                                            <a href="{{ asset('assets/img/assetcontrolExcel.xlsx') }}"
                                                                download><u>Download Sample Excel File</u></a>
                                                        </h5>
                                                        <form action="{{ route('excel_import') }}"
                                                            class="needs-validation" method="POST"
                                                            enctype="multipart/form-data" novalidate>
                                                            @csrf
                                                            <br>
                                                            ...
                                                            <input type="file" id="my_import" style="display: none;"
                                                                name="file" required />
                                                            <div class="invalid-feedback card-title"
                                                                style="color:red;font-size:12px;">
                                                                Please import your excel file.
                                        ...
                                        <form id="clear">
                                            <div class="row" style="text-wrap: nowrap">
                                                ...
                                                <div class="col-md-3" id="filter_col2" data-column="2">
                                                    <label class="form-label" style="font-size: 15px;">Document
                                                        No:</label>
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Enter Doc No" id="col2_filter"
                                                ...
                                                <div class="col-md-3" id="filter_col4" data-column="4">
                                                    ...
                                                    <select class="form-select column_filter"
                                                        aria-label="Default select example" id="col4_filter"
                                                        name="department">
                                                ...
                                                <div class="col-md-3" id="filter_col5" data-column="5">
                                                    <label class="form-label" style="font-size: 15px;">Employee
                                                        ID</label>
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Enter Emp ID" id="col5_filter"
                                                        style="border:1px solid #1c1c1d;">
                                                </div>


                                                <div class="col-md-3 mt-3" id="filter_col6" data-column="6">
                                                    <label class="form-label" style="font-size: 15px;">Employee
                                                        Name</label>
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Enter Emp Name" id="col6_filter"
                                                        style="border:1px solid #1c1c1d;">
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-3" id="filter_col7" data-column="7">
                                                    <label for="validationCustom05" class="form-label"
                                                        style="font-size: 15px;">Phone </label>
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Enter Phone" id="col7_filter"
                                                        style="border:1px solid #0d0d0e;">
                                                </div>

                                                <div class="col-md-3 mt-3" id="filter_col8" data-column="8">
                                                    <label for="validationCustom05" class="form-label"
                                                        style="font-size: 15px;">Select Contract</label>
                                                    <select class="form-select column_filter"
                                                        aria-label="Default select example" id="col8_filter"
                                                        name="department">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <a class="nav-link collapsed"
                                                        href="{{ route('laptop_asset_code.fix_asset') }}">
                                        ...
                                        <div class="table-responsive" style="margin-top:15px;">
                                            <div class="table-responsive">
                                                ...
                                                @endif
                                                <table
                                                    class="table table-sm card-title table-hover table-bordered table-fix"
                                                            ...
                                                            <tr style="text-wrap: nowrap">
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        ...
                                                                        @endif
                                                                        <a
                                                                            href="{{ route('detail_non_asset_detail', $data->doc_no) }}"><i
                                                                                class="bi bi-eye-fill pointer"></i></a>
                                                                        | <a href="" data-bs-toggle="modal"
                                                                            data-bs-target="#move{{ $data->id }}">Move</a>
                                                                    </center>
                                                                </td>
                                                                <td>{{ $data->doc_no }}</td>
                                                                <td>{{ $data->branch }}</td>
                                                                ...
                                                                <td>
                                                                     @foreach (getnonOperator($data->doc_no) as $nonremark)
                                                                        {{ $nonremark->phone }}
                                                                    @endforeach
                                                                </td>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-12">
                                                                                    <form
                                                                                        action="{{ route('asset.move', $data->id) }}"
                                                                                        method="post">
                                                                                        @METHOD('PUT')
                                                                                        @csrf
                                                                                        ...
                                                                                        <input type="text"
                                                                                            ...
                                                                                            style="border:1px solid #1c1c1d;"
                                                                                            name="asset_code"
                                                                                            value="{{ request()->asset_code }}"
                                                                                            required>
                                                                                        <hr>
                                                                                        <button type="submit"
                                                                                            class="btn btn-primary"
                                                                                            style="font-weight: 500; color: #fff; font-family: Poppins, sans-serif;">Move</button>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
                                                                        </div>
